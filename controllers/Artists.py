        ...
        try:
            ...
            for track in top_world_tracks['tracks']:
                if 'avatar' in track['share'].keys():
                    ...
                    if 'artists' in track : D.append({'key':track['artists'][0]['adamid'],'name':track['artists'][0]['alias'],'avatar':None})
            return {'artists':D}
        except Exception:
            return {}
        ...
        try:
            ...
            for artist in artists['artists']['hits']:
                if 'avatar' in artist['artist']:
                    ...
                    D.append({'key':artist['artist']['adamid'],'name':artist['artist']['name'],'weburl':artist['artist']['weburl'],'webuel':None})
            return {'artists':D}
        except Exception:
            return {}
