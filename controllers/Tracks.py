...
class Tracks:
    ...
    async def getTopTracks(self,max:int):
        ...
        try:
            ...
            for track in top_world_tracks['tracks']:
                ...
                D.append({'key':serialized.key,'title':serialized.title,'artist':serialized.subtitle,'url':serialized.ringtone,'cover':serialized.photo_url})
            return {'tracks':D}
        except Exception:
            return {}
    ...
    async def aboutTrack(self,id):
        ...
        try:
            ...
            D["track"] = {'key':serialized.key,'title':serialized.title,'artist':serialized.subtitle,'url':serialized.ringtone,'cover':serialized.photo_url}
            return D
        except Exception as err:
            print(err)
            return {}
